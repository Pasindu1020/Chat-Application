...
public class UserLourdes extends javax.swing.JFrame {
    ...
    public UserLourdes() {
        ...
        chatClient = new ChatClient("Lourdes Shenuka", pasinduPanel, lourdesPanel, isheniPanel, vimeshPanel, pramudiPanel, groupChatPanel);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Lourdes Shenuka (You)");
        ...
        pasinduPanel.setFont(new java.awt.Font("Rockwell", 0, 18)); // NOI18N
        ...
        jLabel19.setText("Lourdes Shenuka");
        ...
        jLabel23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Profile 1.png"))); // NOI18N
...
//        jTabbedPane2.setSelectedIndex(3);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserLourdes().setVisible(true);
            }
        });
    }
