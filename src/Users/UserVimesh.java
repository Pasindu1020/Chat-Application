...
public class UserVimesh extends javax.swing.JFrame {
    ...
    public UserVimesh() {
        ...
        chatClient = new ChatClient("Vimesh Gunasekaran", pasinduPanel, lourdesPanel, isheniPanel, vimeshPanel, pramudiPanel, groupChatPanel);
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Vimesh Gunasekaran (You)");
        ...
        jLabel19.setText("Vimesh Gunasekaran");
...
//        jTabbedPane2.setSelectedIndex(4);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Display the sent message in the Group Chat JPanel
        // addMessageToPanel(groupChatPanel,message, true);  // Sent message, align right
        jTextField2.setText("");
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        String receiver = "Pasindu Harshamal";  // Example receiver; get this dynamically from the UI
    ...
    private void jButtonSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSendActionPerformed
        String receiver = "Isheni Thamel";  // Example receiver; get this dynamically from the UI
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserVimesh().setVisible(true);
            }
        });
    }
