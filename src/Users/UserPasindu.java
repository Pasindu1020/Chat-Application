...
public class UserPasindu extends javax.swing.JFrame {
    ...
    public UserPasindu() {
        ...
        chatClient = new ChatClient("Pasindu Harshamal", pasinduPanel, lourdesPanel, isheniPanel, vimeshPanel, pramudiPanel, groupChatPanel);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Pasindu Harshamal (You)");
        ...
        jLabel19.setText("Pasindu Harshamal");
        ...
        jLabel22.setText(".............Good things take time...........");

        jLabel23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Profile Pasindu.png"))); // NOI18N
...
//        jTabbedPane2.setSelectedIndex(2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Send the group message to the server via ChatClient's sendGroupMessage method
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserPasindu().setVisible(true);
            }
        });
    }
